...
SRC_URI="http://homepages.tu-darmstadt.de/~p_larbig/wlan/${PN}-${PV}-04022008.tar.bz2"
S="${WORKDIR}/${PN}"
...
sed s/set_channel/ipwraw_set_channel/g Intel_files/set_channel > ipwraw_set_channel

sed s/set_power/ipwraw_set_power/g Intel_files/set_power > ipwraw_set_power

sed 1,10s/load/ipwraw_load/g Intel_files/load > ipwraw_load
...
sed -e 's/ap-beacon/ipwraw_ap_beacon/g' -e 's/util\/wifi_tx/wifi_tx/g' ap-beacon  > ipwraw_ap_beacon
...
doins ucode/iwlwifi-3945.ucode
